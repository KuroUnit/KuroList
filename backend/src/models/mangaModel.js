...
const excludedTagIDs = [
  ...
  "b13b2a48-c720-44a9-9c77-39c9979373fb", "ddefd648-5140-4e5f-ba18-4eca4071d19b",
  "fad12b5e-68ba-460e-b933-9ae8318f5b65"
];

export const mangaModel = {
  findById: async (mangaId) => {
    const params = {
      'includes[]': 'cover_art'
    }

    const response = await axios.get(`${MANGADEX_API_URL}/manga/${mangaId}`, { params });
